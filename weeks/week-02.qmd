...
- Weather files and climate data [NOAA](https://www.ncei.noaa.gov/cdo-web/)
...
- Planning Department GIS datasets (ESRI)
...
## The Open Office "Collaboration" Paradox

Harvard study of 100,000 employees moving to open offices: face-to-face interaction dropped 70%, email use increased 50%.

- **Who:** Ethan Bernstein & Stephen Turban (Harvard Business School, 2018)
- **Method:** Sociometric badges tracking 150 employees for 6 weeks
- **Published:** Philosophical Transactions of Royal Society B

*Sometimes the data tells a different story than expected.*
:::
...
## The McDonald's Ice Cream Machine Mystery

Franchise owners couldn't access diagnostic data from their own machines. A 24-year-old built a device to decode error messages - revealing machines weren't broken, just had confusing interfaces.

- **Who:** Rashiq Zahid (24, Berlin) created mcbroken.com tracking tool (2020)
- **Device:** Kytch by Melissa Nelson & Jeremy O'Sullivan
- **Outcome:** $900M lawsuit, FTC investigation, right-to-repair victory (2024)

*Data access challenges aren't unique to buildings.*
:::
...
- Systematic literature/existing work review of your topic
...
4. **Draft mentor questions** - what would you ask a practitioner/senior?
